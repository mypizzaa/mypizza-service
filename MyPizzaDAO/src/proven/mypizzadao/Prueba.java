...
//        System.out.println("Add a pizza: "+ m.addPizza(new Pizza("Pizza Queso", 13.95, null, 1), createListOfIngredients()));
//        System.out.println("Add an ingredient: "+m.addIngredient(new Ingrediente("Ajo", 0.50, "", 3)));
//        System.out.println("Add a drink: "+m.addDrink(new Refresco("Fanta limon", 1.8, null, 2)));
//       System.out.println("Modify product: "+ m.modifyProductInfo(new Producto(43, "Atun", 0.50, "")));
...
//        System.out.println("Remove igredients from pizza: "+ m.removeIngredientFromPizza(new Pizza(12), removeIngredients()));
        System.out.println("Remove ingrediente: "+m.removeIngrediente(new Ingrediente(29)));
//        System.out.println("Remove drink: "+m.removeDrink(new Refresco(2)));
//        System.out.println("");
//        System.out.println("/*************Client*************/");
//        System.out.println("List all clients: "+m.listAllClients());
//        System.out.println("Find client by dni: "+ m.findClientByDni(new Cliente("78414103L")));
...
//        System.out.println("Check if exist: "+ m.checkIfDniExist("12642375A"));
//        System.out.println("Modify password: "+ m.modifyPassword(new Cliente("56693619E", "changepass")));
